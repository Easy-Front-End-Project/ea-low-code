...
export class PagesController {
  ...
  async findOne(@Query('id', ParseIntPipe) id: number, @NestRequest() req: any) {
    const userId = req.user.userId
  ...
  async findPageDetail(@Query('id', ParseIntPipe) id: number, @NestRequest() req: any) {
    const userId = req.user.userId
  ...
  async create(@Body() createProjectDto: CreateProjectDto, @NestRequest() req: any) {
    const userId = req.user.userId
  ...
  async createPage(@Body() createPageDto: CreatePageDto, @NestRequest() req: any) {
    const userId = req.user.userId
  ...
  async update(@Body() updateProjectDto: UpdateProjectDto, @NestRequest() req: any) {
  ...
  async updatePage(@Body() updatePageDto: UpdatePageDto, @NestRequest() req: any) {
    const userId = req.user.userId
  ...
  async remove(@Body() deleteProjectDto: DeleteProjectDto, @NestRequest() req: any) {
    const userId = req.user.userId
  ...
  async clone(@Body() deleteProjectDto: DeleteProjectDto, @NestRequest() req: any) {
    const userId = req.user.userId
  ...
  async removePage(@Body() deletePageDto: DeletePageDto, @NestRequest() req: any) {
    const userId = req.user.userId
  ...
  async clonePage(@Body() deletePageDto: DeletePageDto, @NestRequest() req: any) {
    const userId = req.user.userId
