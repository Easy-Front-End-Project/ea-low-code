...
export class AuthService {
  ...
  async sendVerificationCode(
    ...
    const sent = await this.emailService.sendVerificationCode(email, code, purposeText)
  ...
  async resetPassword(resetPasswordDto: ResetPasswordDto): Promise<{ message: string }> {
    ...
    // 验证验证码
    const isCodeValid = this.verificationCodeService.verifyCode(email, code, 'resetPassword')
    if (!isCodeValid) {
