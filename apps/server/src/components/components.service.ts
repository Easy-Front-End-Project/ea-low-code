...
export class ComponentsService {
  ...
  async createPreset(userId: number, data: { name?: string; url?: string; isDefault?: boolean }) {
    if (data.isDefault)
      await this.urlPresetRepository.update({ userId, isDefault: true }, { isDefault: false })
  ...
  getFullUrl(component: { url: string; urlPresetId?: number }, presets: UrlPreset[]) {
