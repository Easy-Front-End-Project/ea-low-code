...
<script setup>
  ...
  import { getComponentMeta, getRemoteComponentMetaList } from '@/components/designer/constants/componentMeta'
  import PropConfig from '@/components/designer/configs/PropConfig.vue'
  import BaseStyleConfig from '@/components/designer/configs/BaseStyleConfig.vue'
  import ComponentStyleConfig from '@/components/designer/configs/ComponentStyleConfig.vue'
  import EventConfig from '@/components/designer/configs/EventConfig.vue'
  import SlotConfig from '@/components/designer/configs/SlotConfig.vue'
  import SlotScopeConfig from '@/components/designer/configs/SlotScopeConfig.vue'
