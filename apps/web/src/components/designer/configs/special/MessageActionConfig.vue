<template>
  <div class="message-action-config space-y-3">
    ...
    <div class="config-item">
      <label class="config-label">偏移距离</label>
      <EaInputNumber v-model="modelValue.offset" :min="0" :step="8" size="small" placeholder="16" />
    </div>
  </div>
</template>
